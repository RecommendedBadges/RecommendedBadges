...
const LAMBDA_INVOKE_COMMAND = `aws lambda invoke --function-name ${process.env.PACKAGING_LAMBDA_ARN} --invocation-type Event --no-cli-auto-prompt --cli-binary-format raw-in-base64-out --region ${process.env.AWS_DEFAULT_REGION}`;
